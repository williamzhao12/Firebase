...
class LoginController: UIViewController {
    ...
    //1. place autolayout constraints into own method
    //2. instead of creating a programmatic constructor, create a block.
    ...
    let nameSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 123, g: 123, b: 123)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    let emailSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 123, g: 123, b: 123)
        //don't forget this line or else you can't see the item
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
...
//        inputsContainerView.translatesAutoresizingMaskIntoConstraints = false
    ...
    func setupLoginRegisterButton() {
        ...
        loginRegisterButton.heightAnchor.constraintEqualToConstant(50)
    }
    
    //what are the five basic things you need for the UI constraints
    //you need to set x, y, width, height and constraints
...
//create a convenience constructor to avoid using 255 when creating a UIColor

extension UIColor {
    //what does convenience do?
